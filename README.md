...
const RULES = {
  ...
  shoeColour: {
    zwart: ['grijs','navy'],
    bruin: ['grijs','navy','bruin','beige','groen','wit'],
    beige: ['bruin','beige','grijs','groen','navy','wit'],
  },
...
- `shoeColour` — per schoenkleur de toegestane pantalonkleuren. Zwarte schoenen
  ...
  sneakers en de jeans wel bij navy, en sinds de witte pantalon ook bij wit.
  Een schoenkleur die hier niet in staat, combineert met alles. Let op de richting: de sleutel is de **schoen**, de lijst
